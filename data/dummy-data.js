...
async function populate() {
  ...
  if (count == 0) {
    const users = await User.bulkCreate([
      {
        fullname: "yuce haydar",
        email: "haydar8w@gmail.com",
        password: await bcrypt.hash("135790", 10),
      },
      {
        fullname: "çınar turan",
        email: "info@cinarturan1.com",
        password: await bcrypt.hash("135790", 10),
      },
      {
        fullname: "çınar turan",
        email: "info@cinarturan2.com",
        password: await bcrypt.hash("135790", 10),
      },
      {
        fullname: "çınar turan",
        email: "info@cinarturan3.com",
        password: await bcrypt.hash("135790", 10),
      },
    ]);
    ...
    const yorum={
      content: "Node.js ile Sıfırdan İleri Seviye Web Geliştirme",
      userId: 1,
      blogId:1,
    }

    //  await blogs[0].addComments(yorum[0])
  }
}
